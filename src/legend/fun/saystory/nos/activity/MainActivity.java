package legend.fun.saystory.nos.activity;
...
import legend.fun.saystory.nos.adapter.MainAdapter;
import legend.fun.saystory.nos.data.Favorite_DBopenHelper;
import legend.fun.saystory.nos.data.Main_Data;
import legend.fun.saystory.nos.data.Pause_DBOpenHelper;
import legend.fun.saystory.nos.mediaplayer.ContinueMediaPlayer;
import legend.fun.saystory.nos.util.Crypto;
import legend.fun.saystory.nos.util.HangulUtil;
import legend.fun.saystory.nos.util.PreferenceUtil;
import legend.fun.saystory.nos.util.Utils;
import legend.fun.saystory.nos.videoplayer.CustomVideoPlayer;
public class MainActivity extends Activity implements OnItemClickListener, OnClickListener, OnScrollListener, AdViewListener, CustomPopupListener, InterstitialAdListener{
	...
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMIXER, "70llnfhy");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB, "ca-app-pub-4637651494513698/2593911361");
	AdMixerManager.getInstance().setAdapterDefaultAppCode(AdAdapter.ADAPTER_ADMOB_FULL, "ca-app-pub-4637651494513698/4070644564");
	
//	  Custom Popup 시작
	CustomPopup.setCustomPopupListener(this);
	CustomPopup.startCustomPopup(this, "70llnfhy");
	...
	public void addBannerView() {
    	AdInfo adInfo = new AdInfo("70llnfhy");
